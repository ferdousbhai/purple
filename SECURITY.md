...
Security fixes are made on the hosted application and the `master` branch.
...
The maintainer will acknowledge receipt and coordinate disclosure after a fix
is available. Please allow a reasonable remediation period before publishing
details.
